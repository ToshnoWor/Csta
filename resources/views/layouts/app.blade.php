...
<head>
    ...
    <title>{{ config('app.name', 'CSta') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex" href="{{ route('dashboard') }}">
                    <div><img src="/svg/logo.svg" alt="=<" style="width: 45px; border-right: 1px solid #333333"
                        class="pr-3"></div>
                    <div class="pl-3 pt-1">{{ config('app.name', 'CSta') }}</div>
                </a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                    <span class="navbar-toggler-icon">Ok</span>
                </button>

                <div class="pt-2 navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
